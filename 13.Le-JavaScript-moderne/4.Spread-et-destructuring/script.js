...
// console.table(shallowArrayCopy);
...
const shaloowObjCopy = { ...obj, dogName: 'Tom' };
// console.dir(shaloowObjCopy);

// si une propriété est rajoutée alors qu'elle provient d'un objet copié, elle sera remplacée.
const shaloowObjCopy2 = { ...obj, name: 'Anna' };
// console.dir(shaloowObjCopy2);
...
const { country, sport = 'Foot', beverage = 'Beer' } = { country: 'Germany' };
console.log(country, sport, beverage);

// Combiner un nom différent et des valeurs par défaut.
const { userName: mainName = 'Hanz' } = { height: 180 };
