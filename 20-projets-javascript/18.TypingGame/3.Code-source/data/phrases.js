 const phrases = [
  ...
  { "id": 4, "text": "Elle lit un livre passionnant chaque soir." },
  { "id": 5, "text": "Le vent souffle fort dans les branches." },
  ...
  { "id": 17, "text": "Les enfants rient dans la cour de récréation." },
  { "id": 18, "text": "Il pleuvait doucement sur les toits de Paris." },
  { "id": 19, "text": "Le silence était profond après la tempête." },
  { "id": 20, "text": "Un jour sans rire est un jour perdu." }
]
