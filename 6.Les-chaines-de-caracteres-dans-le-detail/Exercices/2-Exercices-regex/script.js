...
console.log('str.test("bouquet") : ', /bouquet/.test(str));
...
console.log('str2.match(/a/g) : ', str2.match(/a/g));
...
console.log('str3.test(/5{2,4}/) : ', /5{2,4}/.test(str3));
console.log('str4.test(/5{2,4}/) : ', /5{2,4}/.test(str4));
console.log('str5.test(/5{2,4}/) : ', /5{2,4}/.test(str5));
...
*/
const str6 =
    "Une4 bonne bala1de dan1245s les bois n478ous permet de q548uitter l'atmosphère anxiogène de la ville.";
// A.
console.log('str6.match(/\\d/g) : ', str6.match(/\\d/g));
// B.
console.log('str6.replace(/\\d/g, "") : ', str6.replace(/\d/g, ''));
...
console.log('str7.test(/w?zaza{2}/) : ', /w?zaza{2}/.test(str7));

/* 
    6. Retournez le nombre d'occurences de "Sara" ou "Paul" ou "Pedro" de la chaîne suivante dans la console.
*/
const str8 = 'Tom Joe Paul Paul Paul Lucie Pedro Gabriella Marie Bastien Sara';
console.log(
    'str8.match(/Sara|Paul|Pedro/g) : ',
    str8.match(/Sara|Paul|Pedro/g)
);
