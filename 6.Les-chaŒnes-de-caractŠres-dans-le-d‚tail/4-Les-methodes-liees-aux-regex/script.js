...
*/
console.log('En hiver, il fait froid'.search(/froid/)); // 10
...
console.log('Bo1nj1ou11r l1e m111onde'.replace(/1/, '')); // Bonj1ou11r l1e m111onde
console.log("J'adore les chiens".replace(/chiens/g, 'chat')); // "J'adore les chats"
...
*/
console.log('55-55-55-55-55'.replaceAll('5', '1')); // '11-11-11-11-11'
